...
class LabelsLassoOverlay(SceneOverlay):
    """Overlay for the left-click "encircle and fill" lasso tool.
    ...
    ----------
    enabled : bool
        Whether the overlay is active (gated to LASSO mode).
    active : bool
        Whether a stroke is currently in progress (circle visible).
    center : tuple
        Data coordinates (full-ndim) of the initial click point.
    radius : float
